...
const { isIssueFollowingTemplate } = require('../util')
const issueTemplateFields = [
  '* [ ] Refactored',
  '**Steps to reproduce**',
  '## Feature Request',
  '- [ ] Presubmit',
...
describe('isIssueFollowingTemplate()', () => {
  it('returns true for "* [ ] Refactored"', () => {
    const result = isIssueFollowingTemplate(
      issueTemplateFields[0],
